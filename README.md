...
<body>
    <div class="container">
        <header class="header">
            <h1 class="title">⚔️ Valhalla Fitness Tracker ⚔️</h1>
        ...
        <div class="grid">
            <!-- Create User Section -->
            <div class="section">
                <h2 class="section-title">🛡️ Create New Viking</h2>
            ...
            <div class="section">
                <h2 class="section-title">⚒️ Log Training Session</h2>
        ...
        <div class="section">
            <h2 class="section-title">📜 Viking Training Chronicle</h2>
